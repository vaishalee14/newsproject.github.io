...
class PhotoGalleryController extends Controller
{
    ...
    public function StorePhotoGallery(Request $request){
        ...
        $name_gen = $mulit_image->getClientOriginalExtension();
        Image::make($mulit_image)->resize(700,400)->save('upload/news/'.$name_gen);
...
if($photo_id){
    ...
    PhotoGallery::insert([
        'photo_gallery' => $save_url,
        'post_date' => Carbon::now(), // Correct MySQL format
    ]);
