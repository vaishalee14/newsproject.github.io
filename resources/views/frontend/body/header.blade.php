            ...
            <div class="col-lg-12 col-md-12">
                ...
                <div class="stellarnav dark desktop">
                    ...
                    <ul id="menu-main-menu" class="menu">
                        ...
                        <li id="menu-item-{{ $category->id }}" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-has-children has-sub">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li id="menu-item-{{ $subcategory->id }}" class="menu-item menu-item-type-taxonomy menu-item-object-category">
