        ...
        <div class="text-center w-75 m-auto">
            <div class="auth-logo">
                <a href="index.html" class="logo logo-dark text-center">
                    <span class="logo-lg">
                        <img src="<?php echo e(asset('backend/assets/images/logo-dark.png')); ?>" alt="" height="22">
                    </span>
                </a>
         ...
         <p class="text-white-50">Back to <a href="<?php echo e(route('admin.login')); ?>" class="text-white ms-1"><b>Sign In</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
...
</html><?php /**PATH C:\Users\user1\Downloads\laravel-advanced-news-project-master\resources\views/admin/admin_logout.blade.php ENDPATH**/ ?>