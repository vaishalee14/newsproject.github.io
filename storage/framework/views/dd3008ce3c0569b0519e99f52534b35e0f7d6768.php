...
<script>
 ...
 <!-- InputTags js-->
  <script src="<?php echo e(asset('backend/assets/libs/selectize/js/standalone/selectize.min.js')); ?>"></script>
        <script src="<?php echo e(asset('backend/assets/libs/mohithg-switchery/switchery.min.js')); ?>"></script>
        <script src="<?php echo e(asset('backend/assets/libs/multiselect/js/jquery.multi-select.js')); ?>"></script>
        <script src="<?php echo e(asset('backend/assets/libs/select2/js/select2.min.js')); ?>"></script>
         
        <script src="<?php echo e(asset('backend/assets/libs/devbridge-autocomplete/jquery.autocomplete.min.js')); ?>"></script>
...
</html><?php /**PATH C:\Users\user1\Downloads\laravel-advanced-news-project-master\resources\views/admin/admin_dashboard.blade.php ENDPATH**/ ?>