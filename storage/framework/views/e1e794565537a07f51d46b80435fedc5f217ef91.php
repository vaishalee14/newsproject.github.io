...
<?php echo e($breadsubcat->subcategory_name); ?> | Easy Online News 
...
<a href=" "><i class="las la-home"></i> </a> <i class="las la-chevron-right"></i> <?php echo e($breadsubcat->subcategory_name); ?>
...
<div class="content-details"> <?php echo Str::limit($item->news_details, 100); ?> <a href="<?php echo e(url('news/details/'.$item->id.'/'.$item->news_title_slug)); ?>"> Read More </a>
</div>
</div>
</div>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.home_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user1\Downloads\laravel-advanced-news-project-master\resources\views/frontend/news/subcategory_news.blade.php ENDPATH**/ ?>